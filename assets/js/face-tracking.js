...
(function (root, factory) {
    ...
    FaceRecognition.prototype = {
        ...
        captureVideo: function (rect) {
            ...
            var img = new jsfeat.matrix_t(this.dimen.width, this.dimen.height, jsfeat.U8_t | jsfeat.C1_t);
            jsfeat.imgproc.grayscale(normalized.getContext('2d').getImageData(0, 0, normalized.width, normalized.height).data, this.dimen.width, this.dimen.height, img, jsfeat.COLOR_RGBA2GRAY);
