    ...
    $.fn.extend({
        monthly: function (options) {
            ...
            var options = $.extend(defaults, options),
                ...
                monthNames = options.monthNames || ["Jan", "Feb", "Mar", "Apr", "Mei", "Juni", "Jul", "Agu", "Sep", "Okt", "Nov", "Des"],
                dayNames = options.dayNames || ['MIN', 'SEN', 'SEL', 'RAB', 'KAM', 'JUM', 'SAB'];
            ...
            $(document.body).on('click', '#' + uniqueId + ' a.monthly-day', function (e) {
                ...
                if (options.mode == 'link') {
                    ...
                    var month = $('#' + uniqueId).data('setMonth');
                    var year = $('#' + uniqueId).data('setYear');
                    alert(whichDay+' '+month+' '+year);
                }
                // If events, show events list
                else if (options.mode == 'event' && options.eventList == true) {
                    var whichDay = $(this).data('number');
                    ...
                    if ($(this).hasClass('monthly-past-day') && options.disablePast == true) {
                        ...
                        var mnth = ('0'+setMonth).slice(-2);
                        var dy = ('0'+whichDay).slice(-2);
                        $('' + options.target + '').val(setYear + '-' + mnth + '-' + dy);
