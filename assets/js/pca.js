...
(function (window, undefined) {
    ...
    pca.calcEigen = function (trainingSet) {
        var mean = pca.Matrix.mean(trainingSet);
        ...
        for (var i = 0; i < Mt; i++) {
            ...
            var eigenFace = new jsfeat.matrix_t(100, 100, jsfeat.U8_t | jsfeat.C1_t);
            jsfeat.matmath.multiply_AtB(eigenFace, diff[i], eigenvector);
